...
try {
    $total_records_query = "SELECT COUNT(*) FROM games WHERE categories = 4";
    ...
    $games_query = "SELECT * FROM games WHERE categories = 4 LIMIT :start_from, :records_per_page";
